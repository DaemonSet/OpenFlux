...
extern "C" void
Java_io_openflux_app_NativeBridge_jniclose(
        JNIEnv *env, jobject thiz, jint fd) {
    close(fd);
}

extern "C" jint
Java_io_openflux_app_NativeBridge_sendfd(
...
static const char *classPathName =
        "io/openflux/app/NativeBridge";

static JNINativeMethod method_table[] = {
        { "jniclose", "(I)V",
                (void*) Java_io_openflux_app_NativeBridge_jniclose },
        { "sendfd", "(ILjava/lang/String;)I",
                (void*) Java_io_openflux_app_NativeBridge_sendfd }
};
